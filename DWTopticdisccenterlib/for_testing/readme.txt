DWTopticdisccenterlib MATLAB Python Package
...
2. Installing the DWTopticdisccenterlib Package

A. Change to the directory that contains the file setup.py and the subdirectory 
DWTopticdisccenterlib. If you do not have write permissions, copy all its contents to a 
...
3. Using the DWTopticdisccenterlib Package

The DWTopticdisccenterlib package is on your Python path. To import it into a Python 
script or session, execute:

    import DWTopticdisccenterlib
